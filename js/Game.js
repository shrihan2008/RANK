        ...
        playerRank(){
          ...
          for(var plr in allPlayers){
            if(allPlayers[plr].place===1){
              text("1^st"+allPlayers[plr].name,0,85)
            }
            else if(allPlayers[plr].place===2)
            {
              text("2^nd",allPlayers.name,displayWidth/4,displayHeight/9+73)
            }
            else if(allPlayers[plr].name===3){
              text("3^rd",allPlayers.name,displayWidth/-4,displayHeight/10+76)
            }
            else{
              textSize(60)
              text("Last"+" "+allPlayers[plr].name,0,225)
            }
          }
        }
